        ...
        <li class="nav-item dropdown">
          ...
          <ul class="collapse list-unstyled pl-4 w-100" id="dashboard">
            <li class="nav-item active">
              <a class="nav-link pl-3" href="{{route('user.dashboard')}}"><span class="ml-1 item-text">Default</span></a>
            </li>
            {{-- <li class="nav-item">
              <a class="nav-link pl-3" href="{{route('user.users.index')}}"><span class="ml-1 item-text">Users</span></a>
            </li> --}}
          </ul>
        </li>
      </ul>
