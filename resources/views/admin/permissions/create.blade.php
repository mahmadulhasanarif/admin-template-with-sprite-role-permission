...
<div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 col-xl-8">
        <h3 class="h3 mb-4 page-title">Permission Create </h3>
        <div class="my-4">
          <form method="POST" action="{{route('admin.role_has_permission.store')}}">
            @csrf
            <div class="add_item">

              <div class="form-group ">
                <label for="firstname">Group Name</label>
                    <input type="text" name="group_name" class="form-control" placeholder="Enter permission group Name">
                    @error('group_name')
